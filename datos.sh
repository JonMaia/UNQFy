ts-node src/main addArtist --name 'Arctick Monkeys' --country 'Reino Unido'
...
ts-node src/main addAlbum --artistId 2 --name 'Ruli' --year 2013
...
ts-node src/main addTrack --idAlbum 3 --name 'En Avenidas' --duration 196 --genres 'Pop'
